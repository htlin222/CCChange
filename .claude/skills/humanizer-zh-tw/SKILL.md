...
> Vendored from [kevintsai1202/Humanizer-zh-TW](https://github.com/kevintsai1202/Humanizer-zh-TW)
> (MIT, see `LICENSE` next to this file), itself a fork of op7418/humanizer-zh,
> translated from blader/humanizer. Copied in rather than linked so the cloud
> routine — which only ever sees this repo — can load it. Upstream at the time
> of vendoring: 2026-05-18.
>
> In this repo it is not optional. `daily-changelog-post` runs it over every
> post before the PR is opened.
